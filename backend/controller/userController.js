...
export const patientRegister = catchAsyncErrors(async(req,res,next)=>{
    ...
    const user=await User.create({firstName, lastName, email,phone,password,gender,dob,aadhaar,role
    });
...
export const addNewAdmin = catchAsyncErrors(async(req,res,next)=>{
    ...
    const admin=await User.create({
        firstName, lastName, email,phone,password,gender,dob,aadhaar,role:"Admin",
...
const {firstName, lastName, email,phone,password,gender,dob,aadhaar,doctorDepartment}
=req.body;
